...
public class JWTTokenVerifier extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (Strings.isNullOrEmpty(authorizationHeader)) {
            // Swagger access
            if (request.getRequestURI().equals("/api/") || request.getRequestURI().equals("/api/csrf") ) {
...
//            if (matcher.find())
//                if (request.getRequestURI().replaceAll(matcher.group(), "").equals("/api/district/list/")) {
//                    filterChain.doFilter(request, response);
//                    return;
//                }
//            // list region
//            if (request.getRequestURI().equals("/api/region/list")) {
//                filterChain.doFilter(request, response);
//                return;
//            }
